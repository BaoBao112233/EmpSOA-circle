...
if __name__ == "__main__":
    ...
    val_csk = get_csk_feature(model, tokenizer, data_tra, relations)
    tst_csk = get_csk_feature(model, tokenizer, data_tra, relations)

    with open("./data/ED/csk_features.pkl", 'wb') as f:
        pickle.dump([train_csk, val_csk, tst_csk], f)